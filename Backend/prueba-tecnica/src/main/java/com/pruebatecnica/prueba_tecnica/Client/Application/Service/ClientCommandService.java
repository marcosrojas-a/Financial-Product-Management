...
@Service
public class ClientCommandService implements CreateClientPort, UpdateClientPort, DeleteClientPort {
    ...
    public ClientCommandService(ClientRepositoryPort clientRepositoryPort,
    ...
    public Client execute(CreateClientCommand command) {
        ...
        // El constructor de Client valida edad, longitud de nombre/apellido y formato de correo
    ...
    @Override
    @Transactional
    public Client execute(Long id, UpdateClientCommand command) {
